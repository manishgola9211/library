...
class Takeattendance implements ActionListener,ItemListener
{
JFrame take;
JLabel name;
...
id.setFont(f1);
id.setBounds(100,110,100,50);
take.add(id);

idtf=new JTextField(20);
idtf.setBounds(210,125,120,30);
take.add(idtf);

pass=new JLabel("Password");
pass.setFont(f1);
pass.setBounds(350,110,100,50);
take.add(pass);

passtf=new JTextField(20);
passtf.setBounds(460,125,120,30);
take.add(passtf);

chk=new JButton("Check");
chk.setBounds(600,125,100,30);
chk.addActionListener(this);
take.add(chk);

sem=new Choice();
sem.add("Select Semester");
sem.setBounds(70,170,120,50);
sem.addItemListener(this);
take.add(sem);

br=new Choice();
br.add("Select Branch");
br.setBounds(220,170,120,50);
br.addItemListener(this);
take.add(br);

sub=new Choice();
sub.add("Select Subject");
sub.setBounds(370,170,120,50);
...
stu.add("Group2");
stu.add("Group3");
stu.setBounds(520,170,120,50);
stu.addItemListener(this);
take.add(stu);

go=new JButton("Go");
go.setBounds(650,165,80,30);
...
while(rs.next())
{
sem.add(rs.getString("Semester1"));
br.add(rs.getString("Branch1"));
sub.add(rs.getString("Subject1"));

sem.add(rs.getString("Semester2"));
br.add(rs.getString("Branch2"));
sub.add(rs.getString("Subject2"));

sem.add(rs.getString("Semester3"));
br.add(rs.getString("Branch3"));
sub.add(rs.getString("Subject3"));

sem.add(rs.getString("Semester4"));
br.add(rs.getString("Branch4"));
sub.add(rs.getString("Subject4"));

sem.add(rs.getString("Semester5"));
br.add(rs.getString("Branch5"));
sub.add(rs.getString("Subject5"));

sem.add(rs.getString("Semester6"));
br.add(rs.getString("Branch6"));
...
if(y==0) JOptionPane.showMessageDialog(null,"Wrong Teacher-Id or Password");
}
